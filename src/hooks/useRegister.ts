...
import type { AuthResponse, OtpRequiredResponse, RegisterFormData } from '@/types';
...
export function useRegister() {
  ...
  return useMutation({
    mutationFn: async (data: RegisterFormData) => {
      const response = await api.post<AuthResponse | OtpRequiredResponse>('/auth/register', data);
